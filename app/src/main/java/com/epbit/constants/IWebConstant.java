...
public interface IWebConstant {
     ...
     */
    String Browser_GOOGLEAPI_KEY = "";
    String SERVER_KEY_FORGCM = "";
    /**
     * GCM PROJECT ID used fro notifications ]myan cab
     */
    public static final String SENDER_ID = "392209638251";
    /**
     * SPLASH TIME OUT
     */
     ...
     */
    String Driver_email = "email";
    String Driver_lat = "lat";
    String Driver_long = "long";
