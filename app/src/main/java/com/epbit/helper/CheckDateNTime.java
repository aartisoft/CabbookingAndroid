...
public class CheckDateNTime {
    ...
    public static int check(DatePicker datepicker, TimePicker timepicker, Context context) {
        ...
        if (datepicker.getYear() < today.year) {
            Toast.makeText(context, "Wrong Year Selected", Toast.LENGTH_LONG)
                    .show();
                ...
                if (datepicker.getDayOfMonth() < today.monthDay) {
                    ...
                    if (timepicker.getCurrentHour() < today.hour) {
                        ...
                        if (timepicker.getCurrentMinute() < today.minute) {
                            Toast.makeText(context, "Wrong Minutes", Toast.LENGTH_LONG).show();
                        } else {
                            flag = 0;
                        }
                    } else {
    ...
    public static void make_time(TimePicker timePicker, DatePicker datePicker) {
        ...
        userData.setUserDatehitformat("" + Year + "-" + ((Month + 1) < 10 ? "0" + (Month + 1) : (Month + 1)) + "-" + ((Day) < 10 ? "0" + (Day) : (Day)));
